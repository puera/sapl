...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            'INSERT INTO parlamentares_bancada SELECT * FROM sessao_bancada WHERE EXISTS(SELECT * FROM sessao_bancada);',
            'INSERT INTO parlamentares_cargobancada SELECT * FROM sessao_cargobancada WHERE EXISTS(SELECT * FROM sessao_cargobancada);',
        ),
